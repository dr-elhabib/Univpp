        ...
        public Editdafa3VewModel(card_dafa3 card_dafa3)
        {
            ...
            Ico.getValue<ContentApp>().OpenSample4Dialog();
                    ...
                    else
                    {
                        ...
                        if ((d - d2) > Costd)
                        {
                            MessageBox.Show((card_dafa3.Cost - Costd) + "");
                            ...
                            Ico.getValue<db>().GetUnivdb().parts.ToList().Where(c => c.Id == card_dafa3.id_part).FirstOrDefault().nowcost -= (card_dafa3.Cost - Costd);
                            Ico.getValue<db>().GetUnivdb().parts.ToList().Where(c => c.Id == card_dafa3.id_part).FirstOrDefault().mcost+= (card_dafa3.Cost - Costd);
