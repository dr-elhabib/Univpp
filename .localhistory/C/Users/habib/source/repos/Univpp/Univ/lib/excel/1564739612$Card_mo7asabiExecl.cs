...
namespace Univ.lib
{
    class Card_mo7asabiExecl
    {
        ...
        public void CreateCard()
        {
            ...
            MessageBox.Show((card_mo7sabi.part.process.parts.ToList().Count != 1).ToString());
            MessageBox.Show((card_mo7sabi.part.num_type != 7)).ToString());
            if (card_mo7sabi.part.process.parts.ToList().Count != 1|| card_mo7sabi.part.num_type !=7) { 
